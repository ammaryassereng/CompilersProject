...
{
       0,    90,    90,    91,    93,    94,    97,    98,    99,   100,
     101,   102,   103,   106,   107,   108,   109,   110,   111,   112,
     113,   117,   126,   133,   140,   147,   169,   191,   202,   213,
     230,   247,   264,   283,   305,   327,   338,   349,   366,   383,
     400,   419,   452,   485,   501,   527,   585,   601,   628,   634,
     640,   658,   663,   667,   671,   675,   684,   689,   694,   698,
     703,   708,   713,   725,   733,   744,   747,   753,   786,   805,
     824,   842,   843,   845,   848,   849,   862,   864,   866,   868,
     869,   870,   871,   872,   873,   876,   879,   881,   888,   895,
     902,   911,   918,   925,   932,   939,   946,   953,   960,   969,
     974,   974,   976,   979,   980,   981,   982,   985,   988,   989,
     990,   991,   992
};
#endif
...
#line 147 "yacc.y"
    {
                                                        ...
                                                        if((yyvsp[(4) - (4)].mathinfo).typeId == 0)
                                                        {
                                                            ...
                                                            quad("MOV", (yyvsp[(2) - (4)].varinfo).lexeme, cval,"");
                                                        } 
                                                        else 
                                                        {
                                                            sprintf(cval, "%f", (yyvsp[(4) - (4)].mathinfo).fval);
                                                            quad("MOV", (yyvsp[(2) - (4)].varinfo).lexeme, cval,"");
                                                        }
...
#line 202 "yacc.y"
    {
                                                        ...
                                                        quad("MOV", (yyvsp[(2) - (4)].varinfo).lexeme, fromCharToChar((yyvsp[(4) - (4)].charVal)) ,"");
                                                        if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
                                                            //exit(0);
...
#line 213 "yacc.y"
    {
                                                        char * res = GetFuncInfo((yyvsp[(4) - (4)].FunctionCallInfo).lexeme,scopeId,0);
                                                        if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
                                                            ////exit(0);
                                                        ...
                                                        {
                                                            res = InserNewElementInitial(0,0,(yyvsp[(2) - (4)].varinfo).lexeme,scopeId);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                            }
                                                            printf("var_declaration: INT VAR %s\n",(yyvsp[(2) - (4)].varinfo).lexeme); 
                                                        }
                                                    ;}
    break;
...
#line 230 "yacc.y"
    {
                                                        char * res = GetFuncInfo((yyvsp[(4) - (4)].FunctionCallInfo).lexeme,scopeId,1);
                                                        if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
                                                            ////exit(0);
                                                        ...
                                                        {
                                                            res = InserNewElementInitial(1,0,(yyvsp[(2) - (4)].varinfo).lexeme,scopeId);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                            }
...
#line 247 "yacc.y"
    {
                                                        char * res = GetFuncInfo((yyvsp[(4) - (4)].FunctionCallInfo).lexeme,scopeId,3);
                                                        if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
                                                            ////exit(0);
                                                        ...
                                                        {
                                                            res = InserNewElementInitial(3,0,(yyvsp[(2) - (4)].varinfo).lexeme,scopeId);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                            }
...
#line 264 "yacc.y"
    {
                                                        char * res = GetFuncInfo((yyvsp[(4) - (4)].FunctionCallInfo).lexeme,scopeId,2);
                                                        if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
                                                            ////exit(0);
                                                        ...
                                                        {
                                                            res = InserNewElementInitial(2,0,(yyvsp[(2) - (4)].varinfo).lexeme,scopeId);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                            }
...
#line 283 "yacc.y"
    {
                                                        ...
                                                        if((yyvsp[(5) - (5)].mathinfo).typeId == 0)
                                                        {
                                                            ...
                                                            quad("MOV", (yyvsp[(3) - (5)].varinfo).lexeme, cval,"");
                                                        } 
                                                        else 
                                                        {
                                                            sprintf(cval, "%f", (yyvsp[(5) - (5)].mathinfo).fval);
                                                            quad("MOV", (yyvsp[(3) - (5)].varinfo).lexeme, cval,"");
                                                        }
...
#line 338 "yacc.y"
    {
                                                        ...
                                                        quad("MOV", (yyvsp[(3) - (5)].varinfo).lexeme, fromCharToChar((yyvsp[(5) - (5)].charVal)),"");
...
#line 349 "yacc.y"
    {
                                                            char * res = GetFuncInfo((yyvsp[(5) - (5)].FunctionCallInfo).lexeme,scopeId,0);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                                ////exit(0);
                                                            ...
                                                            {
                                                                res = InserNewElementInitial(0,1,(yyvsp[(3) - (5)].varinfo).lexeme,scopeId);
                                                                if(strcmp (res, (char *)"1") != 0)
                                                                {
                                                                    yyerror(res);
                                                                }
                                                                printf("const var_declaration: INT VAR %s\n",(yyvsp[(3) - (5)].varinfo).lexeme); 
                                                            }
                                                        ;}
    break;
...
#line 366 "yacc.y"
    {
                                                            char * res = GetFuncInfo((yyvsp[(5) - (5)].FunctionCallInfo).lexeme,scopeId,1);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                                ////exit(0);
                                                            ...
                                                            {
                                                                res = InserNewElementInitial(1,1,(yyvsp[(3) - (5)].varinfo).lexeme,scopeId);
                                                                if(strcmp (res, (char *)"1") != 0)
                                                                {
                                                                    yyerror(res);
                                                                }
...
#line 383 "yacc.y"
    {
                                                            char * res = GetFuncInfo((yyvsp[(5) - (5)].FunctionCallInfo).lexeme,scopeId,3);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                                ////exit(0);
                                                            ...
                                                            {
                                                                res = InserNewElementInitial(3,1,(yyvsp[(3) - (5)].varinfo).lexeme,scopeId);
                                                                if(strcmp (res, (char *)"1") != 0)
                                                                {
                                                                    yyerror(res);
                                                                }
...
#line 400 "yacc.y"
    {
                                                            char * res = GetFuncInfo((yyvsp[(5) - (5)].FunctionCallInfo).lexeme,scopeId,2);
                                                            if(strcmp (res, (char *)"1") != 0)
                                                            {
                                                                yyerror(res);
                                                                ////exit(0);
                                                            ...
                                                            {
                                                                res = InserNewElementInitial(2,1,(yyvsp[(3) - (5)].varinfo).lexeme,scopeId);
                                                                if(strcmp (res, (char *)"1") != 0)
                                                                {
                                                                    yyerror(res);
                                                                }
...
#line 419 "yacc.y"
    {   
                                        ...
                                        if((yyvsp[(1) - (3)].mathinfo).typeId != (yyvsp[(3) - (3)].mathinfo).typeId)
                                            {
                                                ...
                                                if((yyvsp[(1) - (3)].mathinfo).typeId == 1) 
                                                {
                                                    (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval + (yyvsp[(3) - (3)].mathinfo).ival;
                                                    quad("ADD", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                                }
                                                else 
                                                {
                                                    (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).ival + (yyvsp[(3) - (3)].mathinfo).fval;
                                                    quad("ADD", fromFloatToChar((yyval.mathinfo).fval), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                                }
                                            }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 0)
                                        {
                                            ...
                                            quad("ADD", fromIntToChar((yyval.mathinfo).ival), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                        }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 1)
                                        {
                                            ...
                                            quad("ADD", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                        }
...
#line 452 "yacc.y"
    {   
                                        ...
                                        if((yyvsp[(1) - (3)].mathinfo).typeId != (yyvsp[(3) - (3)].mathinfo).typeId)
                                            {
                                                ...
                                                {
                                                    (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval - (yyvsp[(3) - (3)].mathinfo).ival;
                                                    quad("SUB", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                                } 
                                                else
                                                {
                                                    (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).ival - (yyvsp[(3) - (3)].mathinfo).fval;
                                                    quad("SUB", fromFloatToChar((yyval.mathinfo).fval), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                                } 
                                        ...
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 0)
                                        {
                                            ...
                                            quad("SUB", fromIntToChar((yyval.mathinfo).ival), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                        }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 1)
                                        {
                                            (yyval.mathinfo).typeId = 1;
                                            (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval - (yyvsp[(3) - (3)].mathinfo).fval;
                                            printf("float => math_expr: MINUS term() = %f\n", (yyval.mathinfo).fval);
                                            quad("SUB", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                        }
                                    ;}
    break;
                                        ...
                                        if((yyvsp[(1) - (3)].mathinfo).typeId != (yyvsp[(3) - (3)].mathinfo).typeId)
                                            {
                                                ...
                                                quad("MUL", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                            }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 0)
                                        {
                                            (yyval.mathinfo).typeId = 0;
                                            ...
                                            quad("MUL", fromIntToChar((yyval.mathinfo).ival), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                        }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 1)
                                        {
                                            (yyval.mathinfo).typeId = 1;
                                            (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval * (yyvsp[(3) - (3)].mathinfo).fval;
                                            printf("float => term MULTIPLY factor() = %f\n", (yyval.mathinfo).fval);
                                            quad("MUL", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                        }
                                    ;}
    break;
...
#line 527 "yacc.y"
    {
                                        ...
                                        if((yyvsp[(1) - (3)].mathinfo).typeId != (yyvsp[(3) - (3)].mathinfo).typeId)
                                            {
                                                ...
                                                { 
                                                    ...
                                                    {
                                                        (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval / (yyvsp[(3) - (3)].mathinfo).ival;
                                                        quad("DIV", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                                    }
                                                }
                                                else
                                                {
                                                    if((yyvsp[(3) - (3)].mathinfo).fval == 0)
                                                    {
                                                        yyerror("WARNING: Possible Division By zero\n");
                                                    }
                                                    else
                                                    {  
                                                        (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).ival / (yyvsp[(3) - (3)].mathinfo).fval;
                                                        quad("DIV", fromFloatToChar((yyval.mathinfo).fval), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                                    }
                                                }
                                        ...
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 0)
                                        {
                                            ...
                                            if((yyvsp[(3) - (3)].mathinfo).ival == 0)
                                            {
                                                ...
                                                (yyval.mathinfo).ival = (yyvsp[(1) - (3)].mathinfo).ival / (yyvsp[(3) - (3)].mathinfo).ival;
                                            quad("DIV", fromIntToChar((yyval.mathinfo).ival), fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival), fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival));
                                        }
                                        else if((yyvsp[(1) - (3)].mathinfo).typeId == 1)
                                        {
                                            (yyval.mathinfo).typeId = 1;
                                            ...
                                            {
                                                (yyval.mathinfo).fval = (yyvsp[(1) - (3)].mathinfo).fval / (yyvsp[(3) - (3)].mathinfo).fval;
                                                quad("DIV", fromFloatToChar((yyval.mathinfo).fval), fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval), fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval));
                                            }
                                        }
                                    ;}
    break;
...
#line 663 "yacc.y"
    {
                                                        ...
                                                        quad("OR", fromBoolToChar((yyval.logicinfo).bval), fromBoolToChar((yyvsp[(1) - (3)].logicinfo).bval), fromBoolToChar((yyvsp[(3) - (3)].logicinfo).bval));
                                                    ;}
    break;
...
#line 667 "yacc.y"
    { 
                                                        (yyval.logicinfo).bval = (yyvsp[(1) - (3)].logicinfo).bval && (yyvsp[(3) - (3)].logicinfo).bval;
                                                        quad("AND", fromBoolToChar((yyval.logicinfo).bval), fromBoolToChar((yyvsp[(1) - (3)].logicinfo).bval), fromBoolToChar((yyvsp[(3) - (3)].logicinfo).bval));
                                                    ;}
    break;
...
#line 671 "yacc.y"
    {
                                                        ...
                                                        quad("NOT", fromBoolToChar((yyval.logicinfo).bval), fromBoolToChar((yyvsp[(2) - (2)].logicinfo).bval),"");
                                                    ;}
    break;
...
#line 675 "yacc.y"
    {
                                                        ...
                                                        if (type == 3 ){//type bool
                                                            ...
                                                            quad("NOT", fromBoolToChar((yyval.logicinfo).bval), (yyvsp[(2) - (2)].varinfo).lexeme,"");
                                                        }else   
...
#line 684 "yacc.y"
    { 
                                                        ...
                                                        quad("GE", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));
                                                    ;}
    break;
...
#line 689 "yacc.y"
    {   
                                                        (yyval.logicinfo).bval = (((yyvsp[(1) - (3)].mathinfo).typeId == 0) ? (yyvsp[(1) - (3)].mathinfo).ival :(yyvsp[(1) - (3)].mathinfo).fval) > (((yyvsp[(3) - (3)].mathinfo).typeId == 0) ? (yyvsp[(3) - (3)].mathinfo).ival :(yyvsp[(3) - (3)].mathinfo).fval);
                                                        printf("statement > statement\n");
                                                        quad("GT", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));
                                                    ;}
    break;
...
#line 694 "yacc.y"
    {   
                                                        (yyval.logicinfo).bval = (((yyvsp[(1) - (3)].mathinfo).typeId == 0) ? (yyvsp[(1) - (3)].mathinfo).ival :(yyvsp[(1) - (3)].mathinfo).fval) == (((yyvsp[(3) - (3)].mathinfo).typeId == 0) ? (yyvsp[(3) - (3)].mathinfo).ival :(yyvsp[(3) - (3)].mathinfo).fval);
                                                        printf("statement == statement\n");
                                                        quad("EQ", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));                                                    ;}
    break;
...
#line 698 "yacc.y"
    {   
                                                        (yyval.logicinfo).bval = (((yyvsp[(1) - (3)].mathinfo).typeId == 0) ? (yyvsp[(1) - (3)].mathinfo).ival :(yyvsp[(1) - (3)].mathinfo).fval) <= (((yyvsp[(3) - (3)].mathinfo).typeId == 0) ? (yyvsp[(3) - (3)].mathinfo).ival :(yyvsp[(3) - (3)].mathinfo).fval);
                                                        printf("statement <= statement\n");
                                                        quad("LE", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));
                                                    ;}
    break;
...
#line 703 "yacc.y"
    {
                                                        (yyval.logicinfo).bval = (((yyvsp[(1) - (3)].mathinfo).typeId == 0) ? (yyvsp[(1) - (3)].mathinfo).ival :(yyvsp[(1) - (3)].mathinfo).fval) < (((yyvsp[(3) - (3)].mathinfo).typeId == 0) ? (yyvsp[(3) - (3)].mathinfo).ival :(yyvsp[(3) - (3)].mathinfo).fval);   
                                                        printf("statement < statement\n");
                                                        quad("LT", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));
                                                    ;}
    break;
...
#line 708 "yacc.y"
    {  
                                                        (yyval.logicinfo).bval = (((yyvsp[(1) - (3)].mathinfo).typeId == 0) ? (yyvsp[(1) - (3)].mathinfo).ival :(yyvsp[(1) - (3)].mathinfo).fval) != (((yyvsp[(3) - (3)].mathinfo).typeId == 0) ? (yyvsp[(3) - (3)].mathinfo).ival :(yyvsp[(3) - (3)].mathinfo).fval); 
                                                        printf("statement != statement\n");
                                                        quad("NE", fromBoolToChar((yyval.logicinfo).bval), ((yyvsp[(1) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(1) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(1) - (3)].mathinfo).fval)), ((yyvsp[(3) - (3)].mathinfo).typeId == 0 ? fromIntToChar((yyvsp[(3) - (3)].mathinfo).ival) : fromFloatToChar((yyvsp[(3) - (3)].mathinfo).fval)));
                                                    ;}
    break;
...
#line 753 "yacc.y"
    {
                                                    ...
                                                    if ((yyvsp[(3) - (3)].mathinfo).typeId == 0)
                                                    {
                                                        ...
                                                        quad("MOV", (yyvsp[(1) - (3)].varinfo).lexeme, cval, "");
                                                    }
...
#line 805 "yacc.y"
    {
                                                    ...
                                                    quad("MOV", (yyvsp[(1) - (3)].varinfo).lexeme, fromCharToChar((yyvsp[(3) - (3)].charVal)) ,"");
                                                    char *res = UpdateVal(type, (yyvsp[(1) - (3)].varinfo).lexeme, scopeId, cval);
                                                    if(strcmp (res, (char *)"1") != 0)
                                                        {
                                                            yyerror(res);
